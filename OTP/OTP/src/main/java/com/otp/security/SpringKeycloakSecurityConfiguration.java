...
public class SpringKeycloakSecurityConfiguration {
	...
	/**
	 * See
	 * https://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#jc-custom-dsls
	 * <ul>
	 * <li>Manage paths securisation here !You must use this configuration in tests
	 * to validate routes securisation</li>
	...
	public static class CommonSpringKeycloakTutorialsSecuritAdapter
		...
		public void init(HttpSecurity http) throws Exception {
			...
			http
					...
					.antMatchers("/logout", "/", "/unsecured", "/otp/*", "/otp/valider/*", "/otp/get/*")
					.permitAll()
					.antMatchers("/user")
					.hasRole("user")
